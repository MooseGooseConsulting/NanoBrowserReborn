...
import { HyperagentSettings } from './components/HyperagentSettings';

type TabTypes = 'general' | 'models' | 'firewall' | 'hyperagent' | 'analytics' | 'help';

const TABS: { id: TabTypes; icon: React.ComponentType<{ className?: string }>; label: string }[] = [
  { id: 'general', icon: FiSettings, label: t('options_tabs_general') },
  { id: 'models', icon: FiCpu, label: t('options_tabs_models') },
  { id: 'firewall', icon: FiShield, label: t('options_tabs_firewall') },
  { id: 'hyperagent', icon: FiSend, label: 'Hyperagent' },
...
const Options = () => {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case 'hyperagent':
        return <HyperagentSettings isDarkMode={isDarkMode} />;
      case 'analytics':
